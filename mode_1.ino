...
void loop() {
  ...
  while(true) {
    // rotate bipolar until horizontal photogate is blocked
    ...
    if(photoRead1 == false && photoRead4 == false) {
      break;
    }
  }
  ...
  while(photoRead2 == true) {
    // rotate unipolar until vertical photogate is blocked
    uniHalfStepCW();
    photoRead2 = digitalRead(photogate2);
  }

  while(photoRead3 == true) {
    // rotate unipolar until vertical photogate is blocked
    biHalfStepCCW();
    photoRead3 = digitalRead(photogate3);
  }
